...
#########################################################################
tf.app.flags.DEFINE_boolean("include_lstm_sin_problems", False,
                            """Include MLP problems.""")
tf.app.flags.DEFINE_boolean("include_conv_lstm_problems", False,
                            """Include Conv LSTM problems""")
tf.app.flags.DEFINE_boolean("include_conv_lstm_5_layer_problems", False,
                            """Include Conv LSTM problems""")
tf.app.flags.DEFINE_boolean("include_conv_UCI_problems", False,
                            """Include Conv LSTM problems""")
tf.app.flags.DEFINE_boolean("include_conv_lstm_WISDM_problems", False,
                            """Include Conv LSTM problems""")
tf.app.flags.DEFINE_boolean("include_lstm_SML_problems", False,
                            """Include Conv LSTM problems""")
...
tf.app.flags.DEFINE_boolean("include_cifar10_conv_problems_v8", False,
                            """Include cifar10 Convnet problems.""")
tf.app.flags.DEFINE_float("lr", 1e-6,
                          """ learning rate.""")
...
#########################################################################
    if FLAGS.include_lstm_sin_problems:
        problems_and_data.extend(ps.pretrain_sin_lstm_problems())

    if FLAGS.include_conv_lstm_problems:
        problems_and_data.extend(ps.pretrain_conv_lstm_problems())

    if FLAGS.include_conv_lstm_5_layer_problems:
        problems_and_data.extend(ps.pretrain_conv_lstm_5_layer_problems())

    if FLAGS.include_conv_UCI_problems:
        problems_and_data.extend(ps.pretrain_conv_UCI_problems())

    if FLAGS.include_conv_lstm_WISDM_problems:
        problems_and_data.extend(ps.pretrain_conv_lstm_WISDM_problems())

    if FLAGS.include_lstm_SML_problems:
        problems_and_data.extend(ps.pretrain_lstm_SML_problems())
...
#########################################################################
    ...
    for problem_itr, (problem, dataset, batch_size) in enumerate(problems_and_data):
        ...
        # for seed in range(8, 9, 4):
            ...
            training_loss_records, testing_loss_records, testing_acc_records, last_itr_loss, parameters, best_acc, _ = metaopt.test_optimizer(
                opt,
                problem,
            ...
            with open(os.path.join(save_dir, 'seed{}_model_params_acc-{}.pickle'.format(seed, best_acc)), 'wb') as l3_record:
