...
def main(_):
  ...
  if FLAGS.include_mnist_conv_problems:
    ...
    problems_and_data.extend(ps.mnist_conv_problems(use_aux_convex=use_aux_convex, aux_convex_dim=FLAGS.aux_convex_dim, aux_convex_ratio=FLAGS.aux_convex_ratio))
