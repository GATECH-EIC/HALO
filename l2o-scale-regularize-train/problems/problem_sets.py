...
def mnist_conv_problems(use_aux_convex=False, aux_convex_dim=20, aux_convex_ratio=1.0, batch_size=64):
  return [
      # (_Spec(pg.ConvNet, ((1, 28, 28), 10, [(3, 3, 8), (5, 5, 8)]),
      #        {"activation": tf.nn.sigmoid}), datasets.mnist(train=True), 64),
      (_Spec(pg.ConvNet, ((1, 28, 28), 10, [(3, 3, 8), (5, 5, 8)]),
             {"activation": tf.nn.relu, "use_aux_convex": use_aux_convex, "aux_convex_dim": aux_convex_dim, "aux_convex_ratio": aux_convex_ratio}), datasets.mnist(train=True), batch_size)
  ]

def adapt_mnist_conv_problems(use_aux_convex=False, aux_convex_dim=20, aux_convex_ratio=1.0, batch_size=64):
  return [
      # (_Spec(pg.ConvNet, ((1, 28, 28), 10, [(3, 3, 8), (5, 5, 8)]),
      #        {"activation": tf.nn.sigmoid}), datasets.mnist(train=True), 64),
      (_Spec(pg.ConvNet, ((1, 28, 28), 5, [(3, 3, 8), (5, 5, 8)]),
             {"activation": tf.nn.relu, "use_aux_convex": use_aux_convex, "aux_convex_dim": aux_convex_dim, "aux_convex_ratio": aux_convex_ratio}), datasets.mnist(train=True, dataset_type="A"), batch_size)
  ]

def adapt_mnist_conv_problems_wide(use_aux_convex=False, aux_convex_dim=20, aux_convex_ratio=1.0, batch_size=64):
  return [
      # (_Spec(pg.ConvNet, ((1, 28, 28), 10, [(3, 3, 8), (5, 5, 8)]),
      #        {"activation": tf.nn.sigmoid}), datasets.mnist(train=True), 64),
...
def cifar10_conv_problems():
  return [
      # (_Spec(pg.ConvNet, ((1, 28, 28), 10, [(3, 3, 8), (5, 5, 8)]),
      #        {"activation": tf.nn.sigmoid}), datasets.mnist(train=True), 64),
      (_Spec(pg.ConvNet, ((3, 32, 32), 10, [(3, 3, 8), (5, 5, 8)]),
             {"activation": tf.nn.relu}), datasets.cifar10(train=True), 64)
  ]

def adapt_cifar10_conv_problems(use_aux_convex=False, aux_convex_dim=20, aux_convex_ratio=1.0, batch_size=64):
  return [
      # (_Spec(pg.ConvNet, ((1, 28, 28), 10, [(3, 3, 8), (5, 5, 8)]),
      #        {"activation": tf.nn.sigmoid}), datasets.mnist(train=True), 64),
      (_Spec(pg.ConvNet, ((3, 32, 32), 5, [(3, 3, 16), (5, 5, 16)]),
             {"activation": tf.nn.relu, "use_aux_convex": use_aux_convex, "aux_convex_dim": aux_convex_dim, "aux_convex_ratio": aux_convex_ratio}), datasets.cifar10(train=True, dataset_type="A"), batch_size)
  ]

def ConvNet_pooling_problems():
  return [
      # (_Spec(pg.ConvNet, ((1, 28, 28), 10, [(3, 3, 8), (5, 5, 8)]),
      #        {"activation": tf.nn.sigmoid}), datasets.mnist(train=True), 64),
      (_Spec(pg.ConvNet_pooling, ((1, 28, 28), 10, mnist_config['A']),
